...
const styles = {
  modal:
    "w-screen h-screen bg-gray-900/90 z-10 fixed top-0 left-0 flex items-center justify-center",
  modalContent: "bg-white rounded-lg p-3 w-[500px] md:w-[400px] sm:w-[370px]",
